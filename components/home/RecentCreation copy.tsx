      ...
      <div className="container3x">
        ...
        {Array(4)
          ...
          .map((_, idx) => (
            <div
              className={cn(
                "flex flex-col md:flex-row px-4 sm:px-6 xl:px-12 pt-6 sm:pt-8 xl:pt-12 mt-6 sm:mt-8 md:mt-10 bg-black-900 border rounded40 gap-y-20 overflow-hidden gap-6 md:gap-10 h-[65vh] absolute w-full recentWorkItem"
              )}
              style={{
                top: `${idx * 20}px`,
              }}
            ...
            >
              ...
              <div className="w-full md:max-w-[740px] md:ml-auto grid grid-cols-2 gap-2 sm:gap-6 xl:gap-10">
